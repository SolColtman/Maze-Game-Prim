...
score=os.path.dirname(os.getcwd())+'\Maze-Game-Prim\score.txt'  # gets file directory from parent folder
open(score, "w").close()
...
def run():
    import first.algorithm  # opens other python file and makes new maze
    main=Game()
    main.setup_game()
    main.run()